name := 'ai-usage-applet'
appid := 'com.github.brandonhc33.ai-usage'
...
user-metainfo-dst := user-prefix / 'share' / 'metainfo' / appid + '.metainfo.xml'
